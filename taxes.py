...
def statetaxes(state, county, agi, maritalStatus, federalTaxes, stateDeductions, stateCredits, dependents, payPeriods=24):
    ...
    * Maximum withholding wage base of $147,000 (maximum annual withholding of $3,601.50).
    ** Maximum withholding wage base of $147,000 (maximum annual withholding of $2,940.00).
    ...
    # !lots of weird local taxes
        ...
        stateBracket = .045
        taxes = agi * stateBracket
        kentuckyCounties = {"Bowling Greeen": .0185,
                            "Covington": .0245,
                            "Florence": .0200,
                            "Frankfort": .0195,
